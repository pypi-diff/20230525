# Comparing `tmp/makejinja-2.0.0b4.tar.gz` & `tmp/makejinja-2.0.0b5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "makejinja-2.0.0b4.tar", max compression
+gzip compressed data, was "makejinja-2.0.0b5.tar", max compression
```

## Comparing `makejinja-2.0.0b4.tar` & `makejinja-2.0.0b5.tar`

### file list

```diff
@@ -1,12 +1,12 @@
--rw-r--r--   0        0        0     1067 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/LICENSE
--rw-r--r--   0        0        0    16708 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/README.md
--rw-r--r--   0        0        0      101 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/__init__.py
--rw-r--r--   0        0        0       48 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/__main__.py
--rw-r--r--   0        0        0     6783 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/app.py
--rw-r--r--   0        0        0     1211 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/cli.py
--rw-r--r--   0        0        0    12243 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/config.py
--rw-r--r--   0        0        0     1060 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/loader.py
--rw-r--r--   0        0        0        0 2023-05-25 14:26:23.801075 makejinja-2.0.0b4/makejinja/py.typed
--rw-r--r--   0        0        0      813 2023-05-25 14:27:45.894289 makejinja-2.0.0b4/pyproject.toml
--rw-r--r--   0        0        0    17929 1970-01-01 00:00:00.000000 makejinja-2.0.0b4/setup.py
--rw-r--r--   0        0        0    17570 1970-01-01 00:00:00.000000 makejinja-2.0.0b4/PKG-INFO
+-rw-r--r--   0        0        0     1067 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/LICENSE
+-rw-r--r--   0        0        0    16708 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/README.md
+-rw-r--r--   0        0        0      101 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/__init__.py
+-rw-r--r--   0        0        0       48 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/__main__.py
+-rw-r--r--   0        0        0     6783 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/app.py
+-rw-r--r--   0        0        0     1211 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/cli.py
+-rw-r--r--   0        0        0    12243 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/config.py
+-rw-r--r--   0        0        0     1060 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/loader.py
+-rw-r--r--   0        0        0        0 2023-05-25 20:18:40.776748 makejinja-2.0.0b5/makejinja/py.typed
+-rw-r--r--   0        0        0      813 2023-05-25 20:20:19.541199 makejinja-2.0.0b5/pyproject.toml
+-rw-r--r--   0        0        0    17929 1970-01-01 00:00:00.000000 makejinja-2.0.0b5/setup.py
+-rw-r--r--   0        0        0    17570 1970-01-01 00:00:00.000000 makejinja-2.0.0b5/PKG-INFO
```

### Comparing `makejinja-2.0.0b4/LICENSE` & `makejinja-2.0.0b5/LICENSE`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/README.md` & `makejinja-2.0.0b5/README.md`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/makejinja/app.py` & `makejinja-2.0.0b5/makejinja/app.py`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/makejinja/cli.py` & `makejinja-2.0.0b5/makejinja/cli.py`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/makejinja/config.py` & `makejinja-2.0.0b5/makejinja/config.py`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/makejinja/loader.py` & `makejinja-2.0.0b5/makejinja/loader.py`

 * *Files identical despite different names*

### Comparing `makejinja-2.0.0b4/pyproject.toml` & `makejinja-2.0.0b5/pyproject.toml`
...
### Comparing `makejinja-2.0.0b4/setup.py` & `makejinja-2.0.0b5/setup.py`
...
### Comparing `makejinja-2.0.0b4/PKG-INFO` & `makejinja-2.0.0b5/PKG-INFO`
