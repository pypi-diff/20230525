# Comparing `tmp/TCLR-1.8.0.tar.gz` & `tmp/TCLR-1.9.0.tar.gz`
...
+gzip compressed data, was "TCLR-1.9.0.tar", last modified: Thu May 25 08:27:24 2023, max compression
```

## Comparing `TCLR-1.8.0.tar` & `TCLR-1.9.0.tar`
...
+drwxr-xr-x   0 jacob      (501) staff       (20)        0 2023-05-25 08:27:24.072538 TCLR-1.9.0/
+-rw-r--r--   0 jacob      (501) staff       (20)     3228 2023-05-25 08:27:24.072419 TCLR-1.9.0/PKG-INFO
+-rw-r--r--   0 jacob      (501) staff       (20)     2570 2022-08-21 10:21:47.000000 TCLR-1.9.0/README.md
+drwxr-xr-x   0 jacob      (501) staff       (20)        0 2023-05-25 08:27:24.071673 TCLR-1.9.0/TCLR/
+-rw-r-----   0 jacob      (501) staff       (20)    38862 2023-05-25 08:25:54.000000 TCLR-1.9.0/TCLR/TCLRalgorithm.py
+-rw-r--r--   0 jacob      (501) staff       (20)      988 2023-05-25 08:16:57.000000 TCLR-1.9.0/TCLR/__init__.py
+drwxr-xr-x   0 jacob      (501) staff       (20)        0 2023-05-25 08:27:24.072248 TCLR-1.9.0/TCLR.egg-info/
+-rw-r--r--   0 jacob      (501) staff       (20)     3228 2023-05-25 08:27:24.000000 TCLR-1.9.0/TCLR.egg-info/PKG-INFO
+-rw-r--r--   0 jacob      (501) staff       (20)      196 2023-05-25 08:27:24.000000 TCLR-1.9.0/TCLR.egg-info/SOURCES.txt
+-rw-r--r--   0 jacob      (501) staff       (20)        1 2023-05-25 08:27:24.000000 TCLR-1.9.0/TCLR.egg-info/dependency_links.txt
+-rw-r--r--   0 jacob      (501) staff       (20)       30 2023-05-25 08:27:24.000000 TCLR-1.9.0/TCLR.egg-info/requires.txt
+-rw-r--r--   0 jacob      (501) staff       (20)        5 2023-05-25 08:27:24.000000 TCLR-1.9.0/TCLR.egg-info/top_level.txt
+-rw-r--r--   0 jacob      (501) staff       (20)       38 2023-05-25 08:27:24.072576 TCLR-1.9.0/setup.cfg
+-rw-r--r--   0 jacob      (501) staff       (20)     1440 2023-05-25 08:26:41.000000 TCLR-1.9.0/setup.py
```

### Comparing `TCLR-1.8.0/PKG-INFO` & `TCLR-1.9.0/PKG-INFO`
...
### Comparing `TCLR-1.8.0/README.md` & `TCLR-1.9.0/README.md`

 * *Files identical despite different names*

### Comparing `TCLR-1.8.0/TCLR/TCLRalgorithm.py` & `TCLR-1.9.0/TCLR/TCLRalgorithm.py`
...
+
+        f_1 = eval(f'df["{f1}"] {self_op1}')
+        f_2 = eval(f'df["{f2}"] {self_op2}')
         
         # cal new features
-        df[new_feature] = eval(f'df["{f1}"] {op} df["{f2}"]')
+        df[new_feature] = eval(f'df["{f_1}"] {op} df["{f_2}"]')
     
     # reture DataFrame 
     return df
```

### Comparing `TCLR-1.8.0/TCLR.egg-info/PKG-INFO` & `TCLR-1.9.0/TCLR.egg-info/PKG-INFO`
...
### Comparing `TCLR-1.8.0/setup.py` & `TCLR-1.9.0/setup.py`
