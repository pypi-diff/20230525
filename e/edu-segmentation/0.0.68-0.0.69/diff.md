# Comparing `tmp/edu_segmentation-0.0.68.tar.gz` & `tmp/edu_segmentation-0.0.69.tar.gz`
...
### Comparing `edu_segmentation-0.0.68/edu_segmentation/model.py` & `edu_segmentation-0.0.69/edu_segmentation/model.py`
