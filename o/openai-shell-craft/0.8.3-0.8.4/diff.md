# Comparing `tmp/openai_shell_craft-0.8.3.tar.gz` & `tmp/openai_shell_craft-0.8.4.tar.gz`
...
### Comparing `openai_shell_craft-0.8.3/LICENSE` & `openai_shell_craft-0.8.4/LICENSE`
