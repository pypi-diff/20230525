# Comparing `tmp/fgo_api_types-2023.5.25.5.6.17.tar.gz` & `tmp/fgo_api_types-2023.5.3.17.28.2.tar.gz`
...
### Comparing `fgo_api_types-2023.5.25.5.6.17/pyproject.toml` & `fgo_api_types-2023.5.3.17.28.2/pyproject.toml`
