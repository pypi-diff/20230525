# Comparing `tmp/fabric2-3.0.1.tar.gz` & `tmp/fabric2-3.1.0.tar.gz`
...
## Comparing `fabric2-3.0.1.tar` & `fabric2-3.1.0.tar`
...
### Comparing `fabric2-3.0.1/tests/connection.py` & `fabric2-3.1.0/tests/connection.py`
...
### Comparing `fabric2-3.0.1/tests/conftest.py` & `fabric2-3.1.0/tests/conftest.py`
...
### Comparing `fabric2-3.0.1/tests/util.py` & `fabric2-3.1.0/tests/util.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/main.py` & `fabric2-3.1.0/tests/main.py`
...
### Comparing `fabric2-3.0.1/tests/runners.py` & `fabric2-3.1.0/tests/runners.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/executor.py` & `fabric2-3.1.0/tests/executor.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/task.py` & `fabric2-3.1.0/tests/task.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/transfer.py` & `fabric2-3.1.0/tests/transfer.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/_support/fabfile.py` & `fabric2-3.1.0/tests/_support/fabfile.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/group.py` & `fabric2-3.1.0/tests/group.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/_util.py` & `fabric2-3.1.0/tests/_util.py`
...
### Comparing `fabric2-3.0.1/tests/config.py` & `fabric2-3.1.0/tests/config.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/tests/init.py` & `fabric2-3.1.0/tests/init.py`
...
### Comparing `fabric2-3.0.1/tasks.py` & `fabric2-3.1.0/tasks.py`
...
### Comparing `fabric2-3.0.1/setup.py` & `fabric2-3.1.0/setup.py`
...
### Comparing `fabric2-3.0.1/fabric2/executor.py` & `fabric2-3.1.0/fabric2/executor.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/tunnels.py` & `fabric2-3.1.0/fabric2/tunnels.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/exceptions.py` & `fabric2-3.1.0/fabric2/exceptions.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/config.py` & `fabric2-3.1.0/fabric2/config.py`
...
### Comparing `fabric2-3.0.1/fabric2/testing/fixtures.py` & `fabric2-3.1.0/fabric2/testing/fixtures.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/testing/base.py` & `fabric2-3.1.0/fabric2/testing/base.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/tasks.py` & `fabric2-3.1.0/fabric2/tasks.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/transfer.py` & `fabric2-3.1.0/fabric2/transfer.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/runners.py` & `fabric2-3.1.0/fabric2/runners.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/group.py` & `fabric2-3.1.0/fabric2/group.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2/connection.py` & `fabric2-3.1.0/fabric2/connection.py`
...
### Comparing `fabric2-3.0.1/fabric2/main.py` & `fabric2-3.1.0/fabric2/main.py`
...
### Comparing `fabric2-3.0.1/fabric2/util.py` & `fabric2-3.1.0/fabric2/util.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/PKG-INFO` & `fabric2-3.1.0/PKG-INFO`
...
### Comparing `fabric2-3.0.1/sites/_shared_static/logo.png` & `fabric2-3.1.0/sites/_shared_static/logo.png`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/getting-started.rst` & `fabric2-3.1.0/sites/docs/getting-started.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/cli.rst` & `fabric2-3.1.0/sites/docs/cli.rst`
...
### Comparing `fabric2-3.0.1/sites/docs/conf.py` & `fabric2-3.1.0/sites/docs/conf.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/concepts/networking.rst` & `fabric2-3.1.0/sites/docs/concepts/networking.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/concepts/authentication.rst` & `fabric2-3.1.0/sites/docs/concepts/authentication.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/concepts/configuration.rst` & `fabric2-3.1.0/sites/docs/concepts/configuration.rst`
...
### Comparing `fabric2-3.0.1/sites/docs/index.rst` & `fabric2-3.1.0/sites/docs/index.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/docs/api/testing.rst` & `fabric2-3.1.0/sites/docs/api/testing.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/shared_conf.py` & `fabric2-3.1.0/sites/shared_conf.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/changelog.rst` & `fabric2-3.1.0/sites/www/changelog.rst`
...
### Comparing `fabric2-3.0.1/sites/www/roadmap.rst` & `fabric2-3.1.0/sites/www/roadmap.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/changelog-v1.rst` & `fabric2-3.1.0/sites/www/changelog-v1.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/installing-1.x.rst` & `fabric2-3.1.0/sites/www/installing-1.x.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/conf.py` & `fabric2-3.1.0/sites/www/conf.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/contact.rst` & `fabric2-3.1.0/sites/www/contact.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/development.rst` & `fabric2-3.1.0/sites/www/development.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/faq.rst` & `fabric2-3.1.0/sites/www/faq.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/upgrading.rst` & `fabric2-3.1.0/sites/www/upgrading.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/installing.rst` & `fabric2-3.1.0/sites/www/installing.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/index.rst` & `fabric2-3.1.0/sites/www/index.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/sites/www/troubleshooting.rst` & `fabric2-3.1.0/sites/www/troubleshooting.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/fabric2.egg-info/PKG-INFO` & `fabric2-3.1.0/fabric2.egg-info/PKG-INFO`
...
### Comparing `fabric2-3.0.1/fabric2.egg-info/SOURCES.txt` & `fabric2-3.1.0/fabric2.egg-info/SOURCES.txt`
...
+fabric2/auth.py
 fabric2/config.py
 fabric2/connection.py
 fabric2/exceptions.py
 fabric2/executor.py
 fabric2/group.py
 fabric2/main.py
 fabric2/runners.py
...
### Comparing `fabric2-3.0.1/LICENSE` & `fabric2-3.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/README.rst` & `fabric2-3.1.0/README.rst`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/integration/connection.py` & `fabric2-3.1.0/integration/connection.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/integration/concurrency.py` & `fabric2-3.1.0/integration/concurrency.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/integration/transfer.py` & `fabric2-3.1.0/integration/transfer.py`

 * *Files identical despite different names*

### Comparing `fabric2-3.0.1/integration/group.py` & `fabric2-3.1.0/integration/group.py`
