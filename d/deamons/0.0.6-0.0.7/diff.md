# Comparing `tmp/deamons-0.0.6.tar.gz` & `tmp/deamons-0.0.7.tar.gz`
...
## Comparing `deamons-0.0.6.tar` & `deamons-0.0.7.tar`
...
### Comparing `deamons-0.0.6/LICENSE` & `deamons-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `deamons-0.0.6/setup.py` & `deamons-0.0.7/setup.py`
