# Comparing `tmp/delu-0.0.16.tar.gz` & `tmp/delu-0.0.17.tar.gz`
...
### Comparing `delu-0.0.16/delu/nn.py` & `delu-0.0.17/delu/nn.py`
...
### Comparing `delu-0.0.16/examples/mnist.py` & `delu-0.0.17/examples/mnist.py`
