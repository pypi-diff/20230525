# Comparing `tmp/dfmodule-0.0.4.1.tar.gz` & `tmp/dfmodule-0.0.4.2.tar.gz`
...
## Comparing `dfmodule-0.0.4.1.tar` & `dfmodule-0.0.4.2.tar`
...
### Comparing `dfmodule-0.0.4.1/common/aws_/__init__.py` & `dfmodule-0.0.4.2/common/aws_/__init__.py`

 * *Files identical despite different names*

### Comparing `dfmodule-0.0.4.1/common/b64uuid_/__init__.py` & `dfmodule-0.0.4.2/common/b64uuid_/__init__.py`

 * *Files identical despite different names*

### Comparing `dfmodule-0.0.4.1/common/compress_/__init__.py` & `dfmodule-0.0.4.2/common/compress_/__init__.py`

 * *Files identical despite different names*

### Comparing `dfmodule-0.0.4.1/setup.py` & `dfmodule-0.0.4.2/setup.py`
