# Comparing `tmp/textbsr-0.0.7.tar.gz` & `tmp/textbsr-0.0.8.tar.gz`
...
## Comparing `textbsr-0.0.7.tar` & `textbsr-0.0.8.tar`
...
### Comparing `textbsr-0.0.7/setup.py` & `textbsr-0.0.8/setup.py`
...
### Comparing `textbsr-0.0.7/textbsr/models/TextEnhancement.py` & `textbsr-0.0.8/textbsr/models/TextEnhancement.py`

 * *Files identical despite different names*

### Comparing `textbsr-0.0.7/textbsr/textbsr.py` & `textbsr-0.0.8/textbsr/textbsr.py`
...
### Comparing `textbsr-0.0.7/textbsr/utils/utils_image.py` & `textbsr-0.0.8/textbsr/utils/utils_image.py`
